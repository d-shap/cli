...
/**
 * The test implementation of the {@link AbstractInputDoubleCommand}.
 *
 * @author Dmitry Shapovalov
 */
public final class AbstractInputDoubleCommandImpl extends AbstractInputDoubleCommand {
     ...
     */
    public AbstractInputDoubleCommandImpl(final String contextKey, final Lines header, final String defaultMessage, final String wrongInputMessage) {
        super();
     ...
     * @param wrongInputMessage the message for the wrong input.
     */
    public AbstractInputDoubleCommandImpl(final Command parentCommand, final String contextKey, final Lines header, final String defaultMessage, final String wrongInputMessage) {
        super(parentCommand);
        _contextKey = contextKey;
        _header = header;
        _defaultMessage = defaultMessage;
