...
/**
 * The test implementation of the {@link AbstractInputStringCommand}.
 *
 * @author Dmitry Shapovalov
 */
public final class AbstractInputStringCommandImpl extends AbstractInputStringCommand {
     ...
     */
    public AbstractInputStringCommandImpl(final String contextKey, final Lines header, final String defaultMessage, final String wrongInputMessage) {
        super();
     ...
     * @param wrongInputMessage the message for the wrong input.
     */
    public AbstractInputStringCommandImpl(final Command parentCommand, final String contextKey, final Lines header, final String defaultMessage, final String wrongInputMessage) {
        super(parentCommand);
        _contextKey = contextKey;
        _header = header;
        _defaultMessage = defaultMessage;
